...
namespace Drupal\greencko\Form;
 ...
 */
class GreenckoAssemblerForm extends AssemblerForm {
  ...
  public function getFormId() {
    return 'greencko_extra_components';
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state, array &$install_state = NULL) {
    ...
    if (!is_null($extraFeatures)) {
      ...
      $form['extra_components_empty'] = [
        '#weight' => 0,
        '#prefix' => '<p>',
        '#markup' => $this->t("No additional features available."),
        '#suffix' => '</p>',
      ];
    }
    ...
    if (!is_null($demoContent)) {
      ...
      $form['demo_content_empty'] = [
        '#weight' => 0,
        '#prefix' => '<p>',
        '#markup' => $this->t("No demo content available."),
        '#suffix' => '</p>',
      ];
    }
